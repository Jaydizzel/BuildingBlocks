...
public class JDWalls {
    ...
    public static final RegistryObject<Block> SPRUCE_LOG_WALL = registerBlock("spruce_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.SPRUCE_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> OAK_LOG_WALL = registerBlock("oak_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> DARK_OAK_LOG_WALL = registerBlock("dark_oak_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> ACACIA_LOG_WALL = registerBlock("acacia_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.ACACIA_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> JUNGLE_LOG_WALL = registerBlock("jungle_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.JUNGLE_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> BIRCH_LOG_WALL = registerBlock("birch_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.BIRCH_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> WARPED_LOG_WALL = registerBlock("warped_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.WARPED_HYPHAE).sound(SoundType.STEM).strength(2f, 2f)));
    public static final RegistryObject<Block> CRIMSON_LOG_WALL = registerBlock("crimson_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.CRIMSON_HYPHAE).sound(SoundType.STEM).strength(2f, 2f)));
    ...
    public static final RegistryObject<Block> SPRUCE_SKINNED_LOG_WALL = registerBlock("spruce_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_SPRUCE_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> OAK_SKINNED_LOG_WALL = registerBlock("oak_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_OAK_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> DARK_SKINNED_OAK_LOG_WALL = registerBlock("dark_oak_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_DARK_OAK_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> ACACIA_SKINNED_LOG_WALL = registerBlock("acacia_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_ACACIA_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> JUNGLE_SKINNED_LOG_WALL = registerBlock("jungle_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_JUNGLE_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> BIRCH_SKINNED_LOG_WALL = registerBlock("birch_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_BIRCH_LOG).sound(SoundType.WOOD).strength(2f, 2f)));
    public static final RegistryObject<Block> WARPED_SKINNED_LOG_WALL = registerBlock("warped_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_WARPED_HYPHAE).sound(SoundType.STEM).strength(2f, 2f)));
    public static final RegistryObject<Block> CRIMSON_SKINNED_LOG_WALL = registerBlock("crimson_skinned_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_CRIMSON_HYPHAE).sound(SoundType.STEM).strength(2f, 2f)));
    ...
    public static final RegistryObject<Block> MANGROVE_LOG_WALL = registerBlock("mangrove_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.MANGROVE_LOG).sound(SoundType.WOOD).strength(1.8f, 1.8f)));
    ...
    public static final RegistryObject<Block> STRIPPED_MANGROVE_LOG_WALL = registerBlock("stripped_mangrove_log_wall", () -> new WallBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_MANGROVE_LOG).sound(SoundType.WOOD).strength(1.8f, 1.8f)));
